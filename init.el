...
(set-face-attribute 'default nil :font "Operator Mono" :weight 'medium :height efs/default-font-size)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Operator Mono" :weight 'medium :height efs/default-font-size)
